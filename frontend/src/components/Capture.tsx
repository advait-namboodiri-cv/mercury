...
type Phase = "compose" | "compressing" | "review";
...
export default function Capture({
  ...
  const leave = () => {
    if (count > 0 && !confirm("Leave without ending the session? Captured insights won't be saved.")) {
      return;
    }
    onLibrary();
  };
  ...
  return (
    <div className="window">
      ...
      {phase === "review" && review ? (
        <ReviewCard insight={review} onKeep={keep} onDiscard={discard} />
      ) : (
        <div className="capture-body">
          ...
          {phase === "compressing" ? (
            <div className="compressing">
              ...
              <div className="compressing-label">Compressing your reflection…</div>
              <p className="subtle">distilling your thought into a clear insight</p>
            </div>
          ) : mode === "speak" ? (
            <div className="mic-stage">
              ...
              <p className="subtle" style={{ textAlign: "center", maxWidth: 320 }}>
                Voice capture is coming soon. For now, switch to <b>Type</b> to capture this
                reflection.
              </p>
            </div>
          ) : (
            <div className="compose-card">
              <textarea
                ...
                placeholder="What struck you? Speak your mind — ramble as much as you like."
              />
          ...
          {phase === "compose" && (
            <div className="capture-foot">
              ...
              <div className="foot-actions">
                ...
                >
                  {saving ? "Saving…" : "End reading session"}
                </button>
              </div>
            </div>
          )}
